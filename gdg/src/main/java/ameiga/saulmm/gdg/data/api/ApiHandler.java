package ameiga.saulmm.gdg.data.api;
...
public class ApiHandler {
	...
	public String getActivitiesURL (String nextToken) {
		d("[DEBUG] ameiga.saulmm.gdg.data.api.ApiHandler.getActivitiesURL ",
				"Getting Activities...");
	...
	public void makeEventRequest (FutureCallback<List<Event>> gdgEventsCallback) {
		d("[DEBUG] ameiga.saulmm.gdg.data.api.ApiHandler.makeEventRequest ",
				"Getting events...");
	...
	public String [] getMemberInsertStatments () {
		InputStream is = context.getResources().openRawResource(R.raw.members);
		BufferedReader reader = new BufferedReader(new InputStreamReader(is));
